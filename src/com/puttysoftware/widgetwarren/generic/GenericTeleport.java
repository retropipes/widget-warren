...
public abstract class GenericTeleport extends MazeObject {
	...
	return WidgetWarren.getApplication().getGameManager().getPlayerManager().getPlayerLocationW();
    }
	...
	WidgetWarren.getApplication().showMessage(this.getName() + ": Destination (" + (this.destCol + 1) + ","
