...
public abstract class GenericWallTrap extends MazeObject {
	...
	WidgetWarren.getApplication().getMazeManager().getMaze().findAllMatchingObjectsAndDecay(this.masterTrigger);
	if (this.number == GenericWallTrap.NUMBER_MASTER) {
	    WidgetWarren.getApplication().getMazeManager().getMaze().masterTrapTrigger();
	} else {
	    WidgetWarren.getApplication().getMazeManager().getMaze().findAllMatchingObjectsAndDecay(this);
	    WidgetWarren.getApplication().getMazeManager().getMaze().findAllMatchingObjectsAndDecay(this.trigger);
	}
