...
public abstract class GenericPotion extends MazeObject {
	...
	WidgetWarren.getApplication().getGameManager().addToScore(GenericPotion.SCORE_CONSUME);
    }
	...
	WidgetWarren.getApplication().getGameManager().addToScore(GenericPotion.SCORE_SMASH);
	return false;
    }
