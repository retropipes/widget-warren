...
public class PoisonBomb extends GenericUsableObject {
	...
	WidgetWarren.getApplication().getMazeManager().getMaze().radialScanPoisonObjects(x, y, z,
		PoisonBomb.EFFECT_RADIUS);
	// Poison the ground, too
	WidgetWarren.getApplication().getMazeManager().getMaze().radialScanPoisonGround(x, y, z,
		PoisonBomb.EFFECT_RADIUS);
    }
