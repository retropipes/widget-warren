...
public class MoonStone extends GenericInventoryableObject {
	...
	SoundManager.playSound(SoundConstants.SOUND_CATEGORY_SOLVING_MAZE, SoundConstants.SOUND_MOON_STONE);
	WidgetWarren.getApplication().getGameManager().addToScore(MoonStone.SCORE_GRAB_STONE);
    }
}