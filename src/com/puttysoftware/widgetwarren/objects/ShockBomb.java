...
public class ShockBomb extends GenericUsableObject {
	...
	WidgetWarren.getApplication().getMazeManager().getMaze().radialScanShockObjects(x, y, z,
		ShockBomb.EFFECT_RADIUS);
	// Shock the ground, too
	WidgetWarren.getApplication().getMazeManager().getMaze().radialScanShockGround(x, y, z,
		ShockBomb.EFFECT_RADIUS);
    }
