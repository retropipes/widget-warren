...
public class RotationWand extends GenericWand {
	...
	final String rres = CommonDialogs.showInputDialog("Rotation Radius:", "WidgetWarren", rChoices,
		rChoices[r - 1]);
	try {
	...
	final String dres = CommonDialogs.showInputDialog("Rotation Direction:", "WidgetWarren", dChoices,
		dChoices[di]);
	...
	if (d) {
	    ...
	    WidgetWarren.getApplication().getGameManager().doCounterclockwiseRotate(r);
	}
